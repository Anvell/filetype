...
private val Pdf = FileType.Matcher { buffer ->
    buffer.matchSignature(0x25, 0x50, 0x44, 0x46)
}

private val Rtf = FileType.Matcher { buffer ->
    buffer.matchSignature(0x7B, 0x5C, 0x72, 0x74, 0x66, 0x31)
}
